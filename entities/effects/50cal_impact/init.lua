...
function EFFECT:Init(data)
	...
	if MAT_ENUM[self.Mat] == 1 then	
		self:Dust()	
	elseif MAT_ENUM[self.Mat] == 2 then
		self:Dirt()
	elseif MAT_ENUM[self.Mat] == 3 then
		self:Sand()
	elseif MAT_ENUM[self.Mat] == 4 then
		self:Metal()
	elseif MAT_ENUM[self.Mat] == 5 then	
		self:Smoke()
	elseif MAT_ENUM[self.Mat] == 6 then	
		self:Wood()
	elseif MAT_ENUM[self.Mat] == 7 then
		self:Glass()
	elseif MAT_ENUM[self.Mat] == 8 then
		self:Blood()
	elseif MAT_ENUM[self.Mat] == 9 then
		self:YellowBlood()
	else
		self:Smoke()
	end
