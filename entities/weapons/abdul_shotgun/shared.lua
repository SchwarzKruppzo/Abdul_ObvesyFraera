...
SWEP.CrosshairType		= "shotgun"
SWEP.CrosshairSize = 16
...
function SWEP:OnPickup( activator )
	activator:AbdulVoice("abdul/wep4.wav")
...
function SWEP:PrimaryAttack()
	...
	self:ShootBullet( 14, 12, 0.08 )
	self.Weapon:EmitSound("Shoot.Shotgun",85,100)
