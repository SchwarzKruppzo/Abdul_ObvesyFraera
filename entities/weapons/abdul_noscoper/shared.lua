...
SWEP.WorldModel			= "models/weapons/w_snip_m98.mdl"
...
function SWEP:GetViewModelPosition( pos, ang )
	pos = pos - ang:Up() * 0.2 - ang:Forward() * 0.1 - ang:Right() *1.25
	return pos, ang
end
...
function SWEP:PrimaryAttack()
	...
	util.Effect("noscoper_muzzle",muzzle)
	...
	bullet.Tracer = 1 
	bullet.Force = 100
	bullet.Damage = math.random(50,72)
	bullet.AmmoType = "mlg"
	bullet.Callback = function( ply, tr, dmginfo )
		...
		if math.random(1,3) == 1 then
			self:Penetrate( ply, tr, dmginfo, "mlg", 1 )
		end
	end
	self:NearMiss()
	self.Owner:FireBullets( bullet );
	self.Weapon:EmitSound(Sound("Shoot.Noscoper"),95,100)
